...
from utils.dataset import load_split_dataset  # noqa: E402

MODELS = [
    ('Vanilla CNN', 'models/saved/vanilla_cnn_phase1_best.keras', 'keras'),
    ('DS-CNN',      'models/saved/best_model_phase1.keras',        'keras'),
    ('BC-ResNet',   'models/saved/bc_resnet_phase1_saved_model',   'savedmodel'),
]
