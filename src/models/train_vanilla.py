...
VANILLA_LABELS_PATH = os.path.join(MODELS_DIR, 'vanilla_cnn_label_classes.npy')
VANILLA_SAVED_MODEL_PATH = os.path.join(MODELS_DIR, 'vanilla_cnn_saved_model')
VANILLA_TFLITE_PATH = os.path.join(os.path.dirname(MODELS_DIR), 'tflite', 'vanilla_cnn_int8.tflite')
VANILLA_REPORT_PATH = os.path.join(RESULTS_DIR, 'metrics', 'vanilla_cnn_report.txt')
...
def main():
    ...
    int8_accuracy, int8_macro_f1 = evaluate_int8_tflite(VANILLA_TFLITE_PATH, X_test, y_test)
    ...
    ds_metrics = load_reference_dscnn_metrics(X_test, y_test)
